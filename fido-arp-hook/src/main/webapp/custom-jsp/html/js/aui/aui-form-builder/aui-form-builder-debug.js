AUI.add('aui-form-builder-base', function(A) {
    var L = A.Lang,
        ...
        CUSTOM_STYLE_CLASS = 'customStyleClass',
        SHOW_IF = 'showIf',
        PREPEND = 'prepend',
        ...
        MAXSIZE = 'maxsize',
        MINSIZE = 'minsize',
        SHOW_IF_FULL_CONTENT = 'showIfFullContent',
            ...
            _dropField: function(dragNode) {
                ...
                if (isAvailableField(availableField)) {
                    var config = {
                        ...
                        customStyleClass: availableField.get(CUSTOM_STYLE_CLASS),
                        showIf: availableField.get(SHOW_IF),
                        ...
                        maxsize: availableField.get(MAXSIZE),
                        minsize: availableField.get(MINSIZE)
                    };
...
AUI.add('aui-form-builder-field', function(A) {
    ...
    var FormBuilderField = A.Component.create({
        ...
        UI_ATTRS: [ACCEPT_CHILDREN, DISABLED, FIELDS, LABEL, NAME, PREDEFINED_VALUE, CUSTOM_STYLE_CLASS, SHOW_IF, REQUIRED, SELECTED, SHOW_LABEL, TIP, UNIQUE],
        ...
        prototype: {
            ...
            getPropertyModel: function() {
                ...
                return [
                    ...
                    {
                        attributeName: CUSTOM_STYLE_CLASS,
                        editor: new A.TextCellEditor(),
                        name: strings[CUSTOM_STYLE_CLASS]
                    },
                    {
                        attributeName: SHOW_IF,
                        editor: new A.TextCellEditor(),
                        name: strings[SHOW_IF]
                    },
                    {
                        attributeName: TIP,
            ...
            _uiSetCustomStyleClass: function(val) {
                var instance = this;
                instance.set(CUSTOM_STYLE_CLASS, val);
            },

            _uiSetShowIf: function(val) {
                var instance = this;
                instance.set(SHOW_IF, val);
            },
        ...
        prototype: {
            ...
            getPropertyModel: function() {
                ...
                AArray.each(model, function(item, index, collection) {
                    ...
                    else if (item.attributeName === CUSTOM_STYLE_CLASS) {
    ...
    var FormBuilderFieldsetField = A.Component.create({
        ...
        ATTRS: {
            ...
            strings:{
                value: {
                    showIfFullContent: 'Show even if step has been filled'
                }
            }

        },

        UI_ATTRS: [ACCEPT_CHILDREN, LABEL, SHOW_LABEL, SHOW_IF_FULL_CONTENT],
        ...
        prototype: {
            ...
            getPropertyModel: function() {
                ...
                return [
                    ...
                    {
                        attributeName: SHOW_IF_FULL_CONTENT,
                        editor: new A.RadioCellEditor({
                            options: {
                                'true': strings[YES],
                                'false': strings[NO]
                        ...
                        formatter: A.bind(instance._booleanFormatter, instance),
                        name: strings[SHOW_IF_FULL_CONTENT]
                    }
                ];
            },

            _uiSetShowIfFullContent:function(val){
                var instance = this;
                instance.set(SHOW_IF_FULL_CONTENT, val);
            },
            ...
            _uiSetOptions: function(val) {
                var instance = this;
                instance._uiSetShowIfFullContent(
                    instance.get(SHOW_IF_FULL_CONTENT)
                );
            }
    ...
    var FormBuilderMultipleChoiceField = A.Component.create({
        ...
        UI_ATTRS: [ACCEPT_CHILDREN, LABEL, NAME, OPTIONS, PREDEFINED_VALUE, CUSTOM_STYLE_CLASS, SHOW_IF, SHOW_LABEL],
        ...
        prototype: {
            ...
            _uiSetOptions: function(val) {
                ...
                instance._uiSetCustomStyleClass(
                    instance.get(CUSTOM_STYLE_CLASS)
                );
                instance._uiSetShowIf(
                    instance.get(SHOW_IF)
                );
            },
        ...
        prototype: {
            ...
            getPropertyModel: function() {
                ...
                model.push({
                    ...
                    editor: new A.TextCellEditor(),
                    name: strings[MAXSIZE]
                });

                model.push({
                    attributeName: MINSIZE,
                    editor: new A.TextCellEditor(),
                    name: strings[MINSIZE]
                });
            ...
            _uiSetMaxsize: function(val) {
                var instance = this;
                instance.set(MAXSIZE, val);
            },

            _uiSetMinsize: function(val) {
                var instance = this;
                instance.set(MINSIZE, val);
            }
                ...
                AArray.each(
                    ...
                    function(item, index, collection) {
                        if (item.attributeName === PREDEFINED_VALUE) {
                            ...
                            collection[index].editor = new A.TextCellEditor();
                        }
                    }
                );
