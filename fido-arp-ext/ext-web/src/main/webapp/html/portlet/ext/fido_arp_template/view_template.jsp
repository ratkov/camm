...
portletURL.setParameter("struts_action", "/fido_arp_template/view_template");
...
<liferay-util:include page="/html/portlet/ext/fido_arp_template/template_toolbar.jsp">
...
<aui:form action="<%= portletURL.toString() %>" method="post" name="fm">
	<liferay-ui:search-form
		page="/html/portlet/ext/fido_arp_template/template_search.jsp"
	/>
</aui:form>
...
>
	...
	>
		...
		<liferay-ui:search-container-column-jsp
			align="right"
			path="/html/portlet/ext/fido_arp_template/template_action.jsp"
		/>
	</liferay-ui:search-container-row>
