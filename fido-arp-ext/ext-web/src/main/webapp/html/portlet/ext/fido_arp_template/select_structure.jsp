...
<c:if test="<%= showToolbar %>">
	<liferay-util:include page="/html/portlet/ext/fido_arp_template/structure_toolbar.jsp">
		<liferay-util:param name="toolbarItem" value="view-all" />
	</liferay-util:include>
</c:if>

<liferay-portlet:renderURL varImpl="portletURL">
	<portlet:param name="struts_action" value="/fido_arp_template/select_structure" />
