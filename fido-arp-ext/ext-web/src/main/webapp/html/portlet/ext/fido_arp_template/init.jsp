...
<%@ page import="com.liferay.portal.LocaleException" %><%@
    ...
    page import="com.liferay.portlet.dynamicdatamapping.*" %><%@
...
<%
    ...
    if(StringUtils.isEmpty(ddmResource) || StringUtils.isBlank(ddmResource)){
        ddmResource = portletConfig.getInitParameter("ddm-resource");
    }
    request.setAttribute("ddmResource", ddmResource);
    ...
    if(StringUtils.isEmpty(scopeAvailableFields) || StringUtils.isBlank(scopeAvailableFields)){
        scopeAvailableFields = "Liferay.FormBuilder.AVAILABLE_FIELDS.DDM_STRUCTURE";
    }
    String scopeStorageType = ParamUtil.getString(request, "scopeStorageType");
    if(StringUtils.isEmpty(scopeStorageType) || StringUtils.isBlank(scopeStorageType)){
        scopeStorageType = "xml";
    }
    ...
    if(StringUtils.isEmpty(scopeStructureType) || StringUtils.isBlank(scopeStructureType)){
        scopeStructureType = "com.liferay.portlet.dynamicdatalists.model.DDLRecordSet";
    }
