...
public class EditTemplateAction extends PortletAction {
	...
	public ActionForward render(
		...
		try {
			...
			com.liferay.portlet.dynamicdatamapping.action.ActionUtil.getTemplate(renderRequest);
		}
		catch (Exception e) {
			if (e instanceof NoSuchTemplateException ||
				e instanceof PrincipalException) {
		...
		return mapping.findForward(
			getForward(
				renderRequest, "portlet.fido_arp_template.edit_template"));
	}
	...
	protected String getSaveAndContinueRedirect(
		...
		portletURL.setParameter(
			"struts_action", "/fido_arp_template/edit_template");
