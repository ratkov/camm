...
package com.fidoarp.dynamicdatamapping.action;
...
import com.fidoarp.dynamicdatamapping.NoSuchTemplateException;
import com.fidoarp.dynamicdatamapping.TemplateNameException;
import com.fidoarp.dynamicdatamapping.TemplateScriptException;
import com.fidoarp.dynamicdatamapping.action.*;
...
public class EditTemplateAction extends PortletAction {
	...
	public ActionForward render(
		...
		try {
			com.fidoarp.dynamicdatamapping.action.ActionUtil.getStructure(renderRequest);
			com.fidoarp.dynamicdatamapping.action.ActionUtil.getTemplate(renderRequest);
		}
		catch (Exception e) {
			if (e instanceof NoSuchTemplateException ||
				e instanceof PrincipalException) {
