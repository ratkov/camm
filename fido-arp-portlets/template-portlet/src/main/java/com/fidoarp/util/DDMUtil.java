...
public class DDMUtil {
	...
	public static com.liferay.portlet.dynamicdatamapping.util.DDM getDDM() {
	...
	public void setDDM(com.liferay.portlet.dynamicdatamapping.util.DDM ddm) {
		PortalRuntimePermission.checkSetBeanProperty(getClass());

		_ddm = ddm;
	}

	private static com.liferay.portlet.dynamicdatamapping.util.DDM _ddm;
