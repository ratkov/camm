...
public class DDMXSDUtil {
	...
	public static com.liferay.portlet.dynamicdatamapping.util.DDMXSD getDDMXSD() {
	...
	public void setDDMXSD(com.liferay.portlet.dynamicdatamapping.util.DDMXSD ddmXSD) {
		PortalRuntimePermission.checkSetBeanProperty(getClass());

		_ddmXSD = ddmXSD;
	}

	private static com.liferay.portlet.dynamicdatamapping.util.DDMXSD _ddmXSD;
