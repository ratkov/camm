...
public class DDMXSDImpl implements DDMXSD {
	...
	public JSONArray getJSONArray(Element element) throws JSONException {
		...
		for (Element dynamicElementElement : dynamicElementElements) {
			...
			if (type.equals(com.liferay.portlet.dynamicdatamapping.util.DDMImpl.TYPE_CHECKBOX)) {
				hiddenAttributesJSONArray.put("required");
			}

			if (type.equals(com.liferay.portlet.dynamicdatamapping.util.DDMImpl.TYPE_DDM_FILEUPLOAD)) {
			...
			if (type.equals(com.liferay.portlet.dynamicdatamapping.util.DDMImpl.TYPE_RADIO) ||
				type.equals(com.liferay.portlet.dynamicdatamapping.util.DDMImpl.TYPE_SELECT)) {
