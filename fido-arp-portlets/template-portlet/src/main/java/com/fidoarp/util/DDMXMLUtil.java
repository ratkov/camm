...
public class DDMXMLUtil {
	...
	public static com.liferay.portlet.dynamicdatamapping.util.DDMXML getDDMXML() {
	...
	public void setDDMXML(com.liferay.portlet.dynamicdatamapping.util.DDMXML ddmXML) {
		PortalRuntimePermission.checkSetBeanProperty(getClass());

		_ddmXML = ddmXML;
	}

	private static com.liferay.portlet.dynamicdatamapping.util.DDMXML _ddmXML;
