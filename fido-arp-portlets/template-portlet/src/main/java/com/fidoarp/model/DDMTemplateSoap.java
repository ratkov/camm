...
public class DDMTemplateSoap implements Serializable {
	public static DDMTemplateSoap toSoapModel(com.liferay.portlet.dynamicdatamapping.model.DDMTemplate model) {
	...
	public static DDMTemplateSoap[] toSoapModels(com.liferay.portlet.dynamicdatamapping.model.DDMTemplate[] models) {
	...
	public static DDMTemplateSoap[] toSoapModels(List<com.liferay.portlet.dynamicdatamapping.model.DDMTemplate> models) {
		List<DDMTemplateSoap> soapModels = new ArrayList<DDMTemplateSoap>(models.size());

		for (com.liferay.portlet.dynamicdatamapping.model.DDMTemplate model : models) {
