...
public class DDMStorageLinkSoap implements Serializable {
	public static DDMStorageLinkSoap toSoapModel(com.liferay.portlet.dynamicdatamapping.model.DDMStorageLink model) {
	...
	public static DDMStorageLinkSoap[] toSoapModels(com.liferay.portlet.dynamicdatamapping.model.DDMStorageLink[] models) {
	...
	public static DDMStorageLinkSoap[] toSoapModels(List<com.liferay.portlet.dynamicdatamapping.model.DDMStorageLink> models) {
		List<DDMStorageLinkSoap> soapModels = new ArrayList<DDMStorageLinkSoap>(models.size());

		for (com.liferay.portlet.dynamicdatamapping.model.DDMStorageLink model : models) {
