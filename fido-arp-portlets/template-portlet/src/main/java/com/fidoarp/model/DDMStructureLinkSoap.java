...
public class DDMStructureLinkSoap implements Serializable {
	public static DDMStructureLinkSoap toSoapModel(com.liferay.portlet.dynamicdatamapping.model.DDMStructureLink model) {
	...
	public static DDMStructureLinkSoap[] toSoapModels(com.liferay.portlet.dynamicdatamapping.model.DDMStructureLink[] models) {
	...
	public static DDMStructureLinkSoap[] toSoapModels(
		...
		for (com.liferay.portlet.dynamicdatamapping.model.DDMStructureLink model : models) {
