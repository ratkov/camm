...
public class DDMStructureSoap implements Serializable {
	public static DDMStructureSoap toSoapModel(com.liferay.portlet.dynamicdatamapping.model.DDMStructure model) {
	...
	public static DDMStructureSoap[] toSoapModels(com.liferay.portlet.dynamicdatamapping.model.DDMStructure[] models) {
	...
	public static DDMStructureSoap[] toSoapModels(List<com.liferay.portlet.dynamicdatamapping.model.DDMStructure> models) {
		List<DDMStructureSoap> soapModels = new ArrayList<DDMStructureSoap>(models.size());

		for (com.liferay.portlet.dynamicdatamapping.model.DDMStructure model : models) {
