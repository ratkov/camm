...
public class DDMContentSoap implements Serializable {
	public static DDMContentSoap toSoapModel(com.liferay.portlet.dynamicdatamapping.model.DDMContent model) {
	...
	public static DDMContentSoap[] toSoapModels(com.liferay.portlet.dynamicdatamapping.model.DDMContent[] models) {
	...
	public static DDMContentSoap[] toSoapModels(List<com.liferay.portlet.dynamicdatamapping.model.DDMContent> models) {
		List<DDMContentSoap> soapModels = new ArrayList<DDMContentSoap>(models.size());

		for (com.liferay.portlet.dynamicdatamapping.model.DDMContent model : models) {
