...
package com.fidoarp.fidoarpusers.search;
...
public class UserSearch extends SearchContainer<User> {
	...
	public UserSearch(
		...
		super(
			portletRequest, new com.fidoarp.fidoarpusers.search.UserDisplayTerms(portletRequest),
		...
		com.fidoarp.fidoarpusers.search.UserDisplayTerms displayTerms = (com.fidoarp.fidoarpusers.search.UserDisplayTerms)getDisplayTerms();
		...
		iteratorURL.setParameter(
			com.fidoarp.fidoarpusers.search.UserDisplayTerms.STATUS, String.valueOf(displayTerms.getStatus()));

		iteratorURL.setParameter(
			com.fidoarp.fidoarpusers.search.UserDisplayTerms.EMAIL_ADDRESS, displayTerms.getEmailAddress());
		iteratorURL.setParameter(
			com.fidoarp.fidoarpusers.search.UserDisplayTerms.FIRST_NAME, displayTerms.getFirstName());
		iteratorURL.setParameter(
			com.fidoarp.fidoarpusers.search.UserDisplayTerms.LAST_NAME, displayTerms.getLastName());
		iteratorURL.setParameter(
			com.fidoarp.fidoarpusers.search.UserDisplayTerms.MIDDLE_NAME, displayTerms.getMiddleName());
		iteratorURL.setParameter(
			com.fidoarp.fidoarpusers.search.UserDisplayTerms.ORGANIZATION_ID,
			String.valueOf(displayTerms.getOrganizationId()));
		iteratorURL.setParameter(
			com.fidoarp.fidoarpusers.search.UserDisplayTerms.ROLE_ID, String.valueOf(displayTerms.getRoleId()));
		iteratorURL.setParameter(
			com.fidoarp.fidoarpusers.search.UserDisplayTerms.SCREEN_NAME, displayTerms.getScreenName());
		iteratorURL.setParameter(
			com.fidoarp.fidoarpusers.search.UserDisplayTerms.USER_GROUP_ID,
