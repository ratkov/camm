...
public class GroupSearch extends SearchContainer<Group> {
	...
	public GroupSearch(PortletRequest portletRequest, PortletURL iteratorURL) {
		super(
			portletRequest, new com.fidoarp.fidoarpusers.search.GroupDisplayTerms(portletRequest),
			new GroupSearchTerms(portletRequest), DEFAULT_CUR_PARAM,
			DEFAULT_DELTA, iteratorURL, headerNames, EMPTY_RESULTS_MESSAGE);

		com.fidoarp.fidoarpusers.search.GroupDisplayTerms displayTerms = (com.fidoarp.fidoarpusers.search.GroupDisplayTerms)getDisplayTerms();

		iteratorURL.setParameter(
			com.fidoarp.fidoarpusers.search.GroupDisplayTerms.DESCRIPTION, displayTerms.getDescription());
		iteratorURL.setParameter(
			com.fidoarp.fidoarpusers.search.GroupDisplayTerms.NAME, displayTerms.getName());
