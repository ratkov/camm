...
public class UserSearch extends SearchContainer<User> {
	...
	public UserSearch(
		...
		super(
			portletRequest, new com.liferay.portlet.usersadmin.search.UserDisplayTerms(portletRequest),
		...
		com.liferay.portlet.usersadmin.search.UserDisplayTerms displayTerms = (com.liferay.portlet.usersadmin.search.UserDisplayTerms)getDisplayTerms();
		...
		iteratorURL.setParameter(
			com.liferay.portlet.usersadmin.search.UserDisplayTerms.STATUS, String.valueOf(displayTerms.getStatus()));

		iteratorURL.setParameter(
			com.liferay.portlet.usersadmin.search.UserDisplayTerms.EMAIL_ADDRESS, displayTerms.getEmailAddress());
		iteratorURL.setParameter(
			com.liferay.portlet.usersadmin.search.UserDisplayTerms.FIRST_NAME, displayTerms.getFirstName());
		iteratorURL.setParameter(
			com.liferay.portlet.usersadmin.search.UserDisplayTerms.LAST_NAME, displayTerms.getLastName());
		iteratorURL.setParameter(
			com.liferay.portlet.usersadmin.search.UserDisplayTerms.MIDDLE_NAME, displayTerms.getMiddleName());
		iteratorURL.setParameter(
			com.liferay.portlet.usersadmin.search.UserDisplayTerms.ORGANIZATION_ID,
			String.valueOf(displayTerms.getOrganizationId()));
		iteratorURL.setParameter(
			com.liferay.portlet.usersadmin.search.UserDisplayTerms.ROLE_ID, String.valueOf(displayTerms.getRoleId()));
		iteratorURL.setParameter(
			com.liferay.portlet.usersadmin.search.UserDisplayTerms.SCREEN_NAME, displayTerms.getScreenName());
		iteratorURL.setParameter(
			com.liferay.portlet.usersadmin.search.UserDisplayTerms.USER_GROUP_ID,
