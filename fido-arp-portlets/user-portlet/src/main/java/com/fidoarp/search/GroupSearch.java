...
public class GroupSearch extends SearchContainer<Group> {
	...
	public GroupSearch(PortletRequest portletRequest, PortletURL iteratorURL) {
		super(
			portletRequest, new com.liferay.portlet.usersadmin.search.GroupDisplayTerms(portletRequest),
			new GroupSearchTerms(portletRequest), DEFAULT_CUR_PARAM,
			DEFAULT_DELTA, iteratorURL, headerNames, EMPTY_RESULTS_MESSAGE);

		com.liferay.portlet.usersadmin.search.GroupDisplayTerms displayTerms = (com.liferay.portlet.usersadmin.search.GroupDisplayTerms)getDisplayTerms();

		iteratorURL.setParameter(
			com.liferay.portlet.usersadmin.search.GroupDisplayTerms.DESCRIPTION, displayTerms.getDescription());
		iteratorURL.setParameter(
			com.liferay.portlet.usersadmin.search.GroupDisplayTerms.NAME, displayTerms.getName());
