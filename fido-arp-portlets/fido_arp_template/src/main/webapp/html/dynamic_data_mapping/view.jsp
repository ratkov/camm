...
<c:if test="<%= showToolbar %>">
	<liferay-util:include page="/html/dynamic_data_mapping/toolbar.jsp">
...
<aui:form action="<%= portletURL.toString() %>" method="post" name="fm">
	<liferay-ui:search-form
		page="/html/dynamic_data_mapping/structure_search.jsp"
	/>
</aui:form>
...
>
	...
	>
		...
		<liferay-ui:search-container-column-jsp
			align="right"
			path="/html/dynamic_data_mapping/structure_action.jsp"
		/>
	</liferay-ui:search-container-row>
